...
const Book = ({ book }) => {
  ...
  return (
    <>
      <div className="justify-self-centerrounded-xl flex flex-col justify-between items-start max-w-[26rem] rounded-2xl md:px-6">
        {/* img */}
        <div className="">
        ...
        <Link to={`/bookDetails/${id}`} className="w-full mt-5">
          <button className="btn bg-transparent duration-300 rounded hover:bg-[#f66e5e] hover:text-white w-full">
            See Details
          </button>
        </Link>
      </div>
